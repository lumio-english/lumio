...
SCENE_DATA = [
    ...
    (2, 4, ["boy", "girl"], "The boy waves and says hi. The girl waves and says hi."),
    (2, 5, ["friend", "name"], "My friend's name is Sara."),
    (3, 6, ["apple", "ball", "cat"], "Look! I see an apple, a ball, and a cat!"),
    (3, 7, ["dog", "egg", "fish"], "The dog looks at the egg. The fish looks at the dog!"),
    (3, 8, ["hat", "ice cream"], "Sara wears a hat and eats ice cream near the goat."),
    (4, 9, ["juice", "kite"], "Ziad drinks his juice and flies a big kite!"),
    ...
    (19, 52, ["hungry", "scared"], "Hamad is hungry. Yum! The cat is scared. Meow!"),
]
SCENE_MAP = {}
