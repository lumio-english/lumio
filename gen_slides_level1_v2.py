...
SCENE_DATA = [
    (1, 1, ["boy", "girl"], "The boy waves hello. The girl waves hello too."),
    (1, 2, ["teacher", "friend"], "My teacher teaches me. My friend plays with me."),
    (1, 3, ["mom", "dad"], "My mom hugs me. My dad reads to me."),
    ...
    (9, 25, ["house", "door"], "I open the door to my house."),
    (9, 26, ["bedroom", "window"], "I sleep in my bedroom. I open the window."),
    ...
    (16, 47, ["fish", "bird"], "My fish swims in the bowl. My bird sings a song."),
    ...
    (18, 52, ["circle", "square"], "The ball is a circle. The box is a square."),
