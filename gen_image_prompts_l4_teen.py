...
DESC = {
  ...
  "savings": "a cartoon glass jar full of stacked coins with a small green upward arrow beside it",
  "moneybox": "a cartoon coin-slot moneybox (a round or box-shaped bank with a coin slot, NOT pig-shaped) with a coin dropping into the slot",
  "save": "a cartoon hand dropping a coin into a coin-slot moneybox (NOT pig-shaped)",
